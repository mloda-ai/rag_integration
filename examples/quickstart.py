...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp_dir:
        ...
        ingestion_rows = ingestion_result[0] if ingestion_result and isinstance(ingestion_result[0], list) else ingestion_result
        ...
        assert faiss_files and metadata_files, "Expected FAISS index and metadata sidecar on disk"
        ...
        retrieval_rows = retrieval_result[0] if retrieval_result and isinstance(retrieval_result[0], list) else retrieval_result
